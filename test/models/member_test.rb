...
class MemberTest < ActiveSupport::TestCase
  ...
  test "new admin keeps Booklet newsletter preferences" do
    new_admin = Member.create!(
    ...
    assert new_admin.notify_newsletter_email?
    assert new_admin.notify_newsletter_push?
  end
