Truemail.configure do |config|
  ...
  config.verifier_email = ENV.fetch("TRUEMAIL_VERIFIER_EMAIL", "hello@example.com")
  ...
  # return true. Other validations will not processed even if it was defined in validation_type_for
  # It is equal to empty array by default.
  config.whitelisted_domains = %w[gmail.com]
  ...
  config.blacklisted_mx_ip_addresses = %w[]
  ...
  config.logger = { tracking_event: :all, stdout: true, log_absolute_path: "log/truemail.log" }
end
